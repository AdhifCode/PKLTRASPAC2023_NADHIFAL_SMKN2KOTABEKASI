...
$regresi = new RegresiLinear($x, $y);
$predictedNextDay = $regresi->predictNextDay();
echo "Prediksi hasil penjualan di hari selanjutnya: $predictedNextDay";
